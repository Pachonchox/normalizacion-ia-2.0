...
Busca términos específicos y extrae 10 páginas por búsqueda
"""
...
output_log_dir = r"D:\Scrappers Normalizacion\1.1 ML\Datos de prueba\Paris"
...
def scrape_busqueda_continuo(search_key, search_info, ciclo_num):
    ...
    try:
        ...
        # Scrapear 10 páginas por búsqueda
        for page_num in range(1, 11):  # 10 páginas
...
def ejecutar_scraping_continuo():
    ...
    try:
        while not stop_event.is_set():
            ...
            # Espera corta entre categorías (MODO PRUEBA CONTINUO)
            if busqueda_index < len(busqueda_keys):
                logging.info(f"⏸️ Pausa de 10 minutos antes de próxima categoría...")
                ...
                time.sleep(600)  # 10 minutos entre categorías
            
            # Continuar rotación infinita (presiona Ctrl+C para detener)
            # if ciclo_num > 3:
            #     logging.info("🏁 PRUEBA COMPLETADA: 3 categorías × 10 páginas cada una")
            #     break
...
if __name__ == "__main__":
    ...
    print("📄 10 páginas por búsqueda por ciclo")
